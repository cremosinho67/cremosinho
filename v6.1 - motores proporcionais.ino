...
void controlarCurva(int error) {
 ...
 // A correção determina quanto um dos motores deve2.0 * 
...
// Correcao identica a anterior mas para o motor oposto
...
// Se o erro for positivo, o Motor B(ESQUERDO) diminui a velocidade
